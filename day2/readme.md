...
3. Print the __length__ of the string on the browser console using *console.log()*
4. Change all the string capital letters using **toUpperCase()** method
5. Change all the string to lowercase letters using **toLowerCase()** method
6. Cut (slice) out the first word of the sring using **substr()** or __substring()__ method
7. Slice out the phrase _Days Of JavaScript_ from _30 Days Of JavaScript.
8. Check if the string contains a word **Script** using __includes()__ method
9. Spilt the __string__ into __array__ using __spilit()__ method
10. Split the string 30 Days Of JavaScript at the space using __split()__ method
11. 'Facebook, Google, Microsoft, Apple, IBM, Oracle, Amazon' __split__the string at the comma and change it to an array
