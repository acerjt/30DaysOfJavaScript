...
item.forEach(item => {
  ...
  if (item.innerHTML.includes('Done')) { item.style.backgroundColor = '#00ffa3' } else if (item.innerHTML.includes('Ongoing')) { item.style.backgroundColor = '#e4a026' } else { item.style.backgroundColor = '#b62226' }
})
