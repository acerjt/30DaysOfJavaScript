...
const totalCountriesTitle = document.querySelector('#total-countries-title')
totalCountriesTitle.style.margin = '0px'

const h4 = document.querySelectorAll('.sub-title')
for (const title of h4) {
  title.style.fontWeight = '100'
  title.style.margin = '0px'
}

const countriesContainer = document.querySelector('#countries-container')
countriesContainer.style.margin = '20px 10%'
countriesContainer.style.display = 'flex'
countriesContainer.style.flexWrap = 'wrap'
countriesContainer.style.alignContent = 'center'

for (let i = 0; i < countries.length; i++) {
  const countrieLayout = document.createElement('div')
  countrieLayout.style.width = '15%'
  countrieLayout.style.height = '200px'
  countrieLayout.style.margin = '2px'
  countrieLayout.style.fontSize = '30px'
  countrieLayout.style.display = 'flex'
  countrieLayout.style.alignItems = 'center'
  countrieLayout.style.justifyContent = 'center'
  countrieLayout.style.border = '#f2f2f2 solid 1px'
  countrieLayout.innerHTML = countries[i].name
  countriesContainer.appendChild(countrieLayout)
}
